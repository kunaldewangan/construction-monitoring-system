    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-fixed-top bg-light">
        <div class="container">
            <div class="navbar-header">
                <a href="supervisor_login.php" class="navbar-brand">CMS | Supervisor Login</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <form action="supervisor_login_script.php" method="POST">
                            <h2>Login</h2>
                            <div class="form-group">
                                <input type="email" class="form-control" name="s_username" placeholder="Email">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" name="s_password" placeholder="Password">
                            </div>
                            <input type="submit" class="btn btn-primary" name="s_login" value="Login">
                        </form>        
