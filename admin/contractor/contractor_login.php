        ...
        <nav class="navbar navbar-expand-lg navbar-light navbar-fixed-top bg-light">
            <div class="container">
                <div class="navbar-header">
                    <a href="contractor_login.php" class="navbar-brand">CMS | Contractor Login</a>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="contractor_login_script.php" method="POST">
                                <h2>Login</h2>
                                <div class="form-group">
                                    <input type="email" class="form-control" name="c_username" placeholder="First Name">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" name="c_password" placeholder="Password">
                                </div>
                                <input type="submit" class="btn btn-primary" name="c_login" value="Login">
                            </form>
